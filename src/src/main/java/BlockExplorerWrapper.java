 ...
 */
public class BlockExplorerWrapper {
    private final String apiCode;

    public BlockExplorerWrapper() {
        this(null);
    }
     ...
     */
    public BlockExplorerWrapper(String apiCode) {
    ...
    public List<Transaction> getUnconfirmedTransactions () throws APIException, IOException {
      ...
      //  System.out.println("transation list = " + transactions);
        ...
        //  System.out.println("txobj = " + txObj);
          //  System.out.println("txObj.get(\"double_spend\") = "+txObj.get("double_spend"));
//            System.out.println(txObj.get("double_spend").getAsBoolean());

            //System.out.println("txObj.get(\"double_spend\").getAsBoolean() " + txObj.get("double_spend").getAsBoolean());
            transactions.add(new Transaction(txObj,-1,false));
    ...
    //get new transactions with value more than specified value
    public List getTransactionsWithAmountMoreThan(Long number) throws APIException, IOException {
        List<Transaction> transactions = new LinkedList<Transaction>();
        for (Transaction transaction : getUnconfirmedTransactions()) {
            long totalValue = 0;
